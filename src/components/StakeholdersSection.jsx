        ...
        <AnimatePresence mode="wait">
          {isLoading ? (
            ...
            >
              ...
              >
                <circle cx="11" cy="11" r="9" fill="none" stroke="rgba(14,37,69,0.15)" strokeWidth="2" />
                <motion.circle cx="11" cy="11" r="9" fill="none" stroke="#0E2545" strokeWidth="2"
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <circle cx="8" cy="8" r="7" fill="#0E2545" />
                <motion.path
    ...
    >
      <defs>
        ...
        <linearGradient id="wireGradActive" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#0E2545" />
          <stop offset="100%" stopColor="rgba(14,37,69,0.4)" />
        </linearGradient>
        <filter id="wireGlow">
    ...
    <section ref={sectionRef} className="sh-section" id="stakeholders">
      ...
      <style>{`
        ...
        .sh-card:hover {
          ...
          box-shadow: 0 8px 24px rgba(14,37,69,0.12);
        }
        ...
        .sh-card-border-glow--active {
          border-color: #0E2545;
          box-shadow: 0 0 15px rgba(14,37,69,0.3);
        }
        ...
        .sh-card-notch {
          ...
          width: 24px;
          height: 12px;
          background: #FFFDF0; /* Matches section background for cutout effect */
        ...
        .sh-card-notch--ticked { border-color: #0E2545; }
        .sh-card:hover .sh-card-notch { border-color: #0E2545; }
        ...
        .sh-card-dot {
          ...
          border: 1.5px solid rgba(14,37,69,0.8);
          box-shadow: 0 0 8px rgba(14,37,69,0.2);
          transition: all 0.3s;
        }
        .sh-card-dot--active {
          background: #0E2545;
          box-shadow: 0 0 12px rgba(14,37,69,0.6);
        }
        ...
        .sh-pill--pulse {
          border-color: #0E2545;
          box-shadow: 0 0 20px rgba(14,37,69,0.3), 0 0 40px rgba(14,37,69,0.15);
        }
        .sh-pill-logo {
          height: 30px;
          width: auto;
