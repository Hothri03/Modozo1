...
const BlinkingDelayTracker = () => {
  ...
  return (
    ...
    >
      <span className="w-1.5 h-1.5 rounded-full bg-[#E53E3E] shadow-[0_0_8px_rgba(229,62,62,0.4)]" />
  ...
  return (
    <div className="relative w-full h-[300px] sm:h-[350px] flex items-center justify-between py-6 rounded-3xl border overflow-hidden px-4 sm:px-10" style={{ background: '#FFFDF0', borderColor: '#FFE27A' }}>
      ...
      >
        ...
        <div className="absolute left-10 right-10 top-1/2 -translate-y-1/2 h-[2px] bg-yellow-300/30 z-0 rounded-full" />
          ...
          >
            ...
            <motion.div
              animate={{
                ...
                borderColor: ["#FFE27A", "#FFE27A", "#fca5a5", "#FFE27A"],
                boxShadow: [
              ...
              className="w-full aspect-[4/3] flex items-center justify-center rounded-lg border shadow-sm relative cursor-default transition-colors duration-300" style={{ background: '#FFFDF0', borderColor: '#FFE27A' }}
            >
